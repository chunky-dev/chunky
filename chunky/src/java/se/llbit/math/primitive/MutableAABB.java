...
public class MutableAABB implements Primitive {
	 ...
	 * @param zmax
	 */
	public MutableAABB(double xmin, double xmax, double ymin, double ymax,
	...
	//@Override
	//public void calcNormal(Intersection isect) {
		// no additional update required because normal was calculated during
		// the intersection test (for box, aabb does not care)
	//}
