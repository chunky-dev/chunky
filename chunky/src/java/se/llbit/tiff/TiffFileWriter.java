...
public class TiffFileWriter {
	...
	public void write(BufferedImage image, ProgressListener progressListener) throws IOException {
		...
		for (int y = 0; y < height; ++y) {
			progressListener.setProgress("Writing TIFF", y, 0, height);
			...
			progressListener.setProgress("Writing TIFF", y+1, 0, height);
		}
	 ...
	 */
	public void write32(Scene scene, ProgressListener progressListener) throws IOException {
