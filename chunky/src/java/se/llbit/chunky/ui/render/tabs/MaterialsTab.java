...
public class MaterialsTab extends HBox implements RenderControlsTab, Initializable {
  ...
  public MaterialsTab() {
    ...
    settings.getChildren().addAll(
        ...
        emittance, specular, perceptualSmoothness, perceptualTransmissionSmoothness, ior, metalness,
  ...
  private void updateSelectedMaterial(String materialName) {
    ...
    if (materialExists) {
      ...
      perceptualTransmissionSmoothness.onValueChange(value -> scene.setPerceptualTransmissionSmoothness(materialName, value.floatValue()));
