...
public class TexturePackLoader {
  ...
  static {
    ...
    ALL_TEXTURES.put("sign_acacia", SignTexture.createTextureLoader("acacia", Texture.acaciaSignPost));
    ALL_TEXTURES.put("sign_birch", SignTexture.createTextureLoader("birch", Texture.birchSignPost));
    ALL_TEXTURES.put("sign_dark_oak", SignTexture.createTextureLoader("dark_oak", Texture.darkOakSignPost));
    ALL_TEXTURES.put("sign_jungle", SignTexture.createTextureLoader("jungle", Texture.jungleSignPost));
    ALL_TEXTURES.put("sign_oak", SignTexture.createTextureLoader("oak", Texture.oakSignPost));
    ALL_TEXTURES.put("sign_spruce", SignTexture.createTextureLoader("spruce", Texture.spruceSignPost));
    ALL_TEXTURES.put("sign_crimson", SignTexture.createTextureLoader("crimson", Texture.crimsonSignPost));
    ALL_TEXTURES.put("sign_warped", SignTexture.createTextureLoader("warped", Texture.warpedSignPost));
    ALL_TEXTURES.put("sign_mangrove", SignTexture.createTextureLoader("mangrove", Texture.mangroveSignPost));
    ALL_TEXTURES.put("sign_bamboo", SignTexture.createTextureLoader("bamboo", Texture.bambooSignPost));
    ALL_TEXTURES.put("sign_cherry", SignTexture.createTextureLoader("cherry", Texture.cherrySignPost));
    ALL_TEXTURES.put("sign_pale_oak", SignTexture.createTextureLoader("pale_oak", Texture.paleOakSignPost));
