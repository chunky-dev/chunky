...
public class BigDripleafModel {
  ...
  private static final Quad[] bigDripleafNorth = Model.join(
      new Quad[]{
          ...
          // tip
          new Quad(
              new Vector3(0 / 16.0, 15 / 16.0, 0.25 / 16.0),
              new Vector3(16 / 16.0, 15 / 16.0, 0.25 / 16.0),
              new Vector3(0 / 16.0, 11 / 16.0, 0.25 / 16.0),
              new Vector4(16 / 16.0, 0 / 16.0, 16 / 16.0, 12 / 16.0)
          ),
          new Quad(
              new Vector3(16 / 16.0, 15 / 16.0, 0.25 / 16.0),
              new Vector3(0 / 16.0, 15 / 16.0, 0.25 / 16.0),
              new Vector3(16 / 16.0, 11 / 16.0, 0.25 / 16.0),
              new Vector4(16 / 16.0, 0 / 16.0, 16 / 16.0, 12 / 16.0)
          ),
          // side
          new Quad(
              new Vector3(0.25 / 16.0, 15 / 16.0, 16 / 16.0),
              new Vector3(0.25 / 16.0, 15 / 16.0, 0 / 16.0),
              new Vector3(0.25 / 16.0, 11 / 16.0, 16 / 16.0),
              new Vector4(16 / 16.0, 0 / 16.0, 16 / 16.0, 12 / 16.0)
          ),
          new Quad(
              new Vector3(0.25 / 16.0, 15 / 16.0, 0 / 16.0),
              new Vector3(0.25 / 16.0, 15 / 16.0, 16 / 16.0),
              new Vector3(0.25 / 16.0, 11 / 16.0, 0 / 16.0),
              new Vector4(0 / 16.0, 16 / 16.0, 16 / 16.0, 12 / 16.0)
          ),
          new Quad(
              new Vector3(15.75 / 16.0, 15 / 16.0, 16 / 16.0),
              new Vector3(15.75 / 16.0, 15 / 16.0, 0 / 16.0),
              new Vector3(15.75 / 16.0, 11 / 16.0, 16 / 16.0),
              new Vector4(16 / 16.0, 0 / 16.0, 16 / 16.0, 12 / 16.0)
          ),
          new Quad(
              new Vector3(15.75 / 16.0, 15 / 16.0, 0 / 16.0),
              new Vector3(15.75 / 16.0, 15 / 16.0, 16 / 16.0),
              new Vector3(15.75 / 16.0, 11 / 16.0, 0 / 16.0),
              new Vector4(0 / 16.0, 16 / 16.0, 16 / 16.0, 12 / 16.0)
          )
      },
      // stem
