	...
	public EntitiesTab(RenderControls renderControls) {
		...
		layout.setHorizontalGroup(layout.createParallelGroup()
			...
			.addGroup(layout.createSequentialGroup()
					...
					.addComponent(skinField, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
		...
		layout.setVerticalGroup(layout.createSequentialGroup()
			...
			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
					.addComponent(skinLbl)
					.addComponent(skinField, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
					.addComponent(selectSkinBtn))
			.addPreferredGap(ComponentPlacement.UNRELATED)
			.addComponent(poseLbl)
			.addPreferredGap(ComponentPlacement.RELATED)
