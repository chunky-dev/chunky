...
import se.llbit.chunky.renderer.ui.tabs.EntitiesTab;
...
public class RenderControls extends JDialog implements ViewListener, RenderStatusListener {
	...
	private final RenderControlsTab entitiesTab;
	...
	private void buildUI() {
		...
		addTab("Entities", new ImageIcon(MiscImages.face), entitiesTab);
