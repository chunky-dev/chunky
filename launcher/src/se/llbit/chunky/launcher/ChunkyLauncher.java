...
public class ChunkyLauncher extends JFrame implements UpdateListener {
  ...
  private final Adjuster memoryLimitAdjuster = new Adjuster("Memory limit (MiB)",
      "<html>Maximum Java heap space in megabytes (MiB)<br>"
          + "Do not set this greater than the available memory in your computer!", 1 << 9,
      1 << 14) {
    {
      setLogarithmicMode();
      setClampMax(false);
    ...
    @Override public void valueChanged(double newValue) {
  ...
  private void buildUI() {
    ...
    minecraftDirField
        .setToolTipText("The Minecraft directory is used to find the default textures");
    ...
    launchBtn.addActionListener(new ActionListener() {
      @Override public void actionPerformed(ActionEvent arg0) {
        ...
        if (deployer.launchChunky(ChunkyLauncher.this, settings, version, ChunkyMode.GUI) == 0) {
          settings.save();
          setVisible(false);
          dispose();
        } else {
    ...
    layout.setHorizontalGroup(layout.createSequentialGroup()
        .addGroup(layout.createParallelGroup().addComponent(logo).addComponent(launcherVersionLbl))
        .addPreferredGap(ComponentPlacement.UNRELATED).addGroup(layout.createParallelGroup()
            .addGroup(
                layout.createSequentialGroup().addComponent(info).addGap(20, 40, Short.MAX_VALUE))
            .addGroup(layout.createSequentialGroup().addComponent(versionLbl)
                .addPreferredGap(ComponentPlacement.RELATED).addComponent(versionCB)
                .addPreferredGap(ComponentPlacement.RELATED).addComponent(checkForUpdateBtn)
                .addComponent(busyLbl)).addGroup(
                layout.createSequentialGroup().addComponent(minecraftDirLbl)
                    .addPreferredGap(ComponentPlacement.RELATED).addComponent(minecraftDirField)
                    .addPreferredGap(ComponentPlacement.RELATED).addComponent(browseMcBtn))
            .addGroup(memoryLimitAdjuster.horizontalGroup(layout))
            .addComponent(advancedSettingsToggle).addComponent(advancedPanel).addGroup(
                layout.createSequentialGroup().addComponent(alwaysShowLauncherCB)
                    .addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
                        Short.MAX_VALUE).addComponent(cancelBtn)
                    .addPreferredGap(ComponentPlacement.RELATED).addComponent(launchBtn))));
    layout.setVerticalGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup()
        .addGroup(layout.createSequentialGroup().addComponent(logo)
            ...
            .addComponent(launcherVersionLbl)).addGroup(
            layout.createSequentialGroup().addComponent(info)
                .addPreferredGap(ComponentPlacement.UNRELATED).addGroup(
                layout.createParallelGroup(Alignment.BASELINE).addComponent(versionLbl)
                    .addComponent(versionCB).addComponent(checkForUpdateBtn).addComponent(busyLbl))
                .addPreferredGap(ComponentPlacement.UNRELATED).addGroup(
                layout.createParallelGroup(Alignment.BASELINE).addComponent(minecraftDirLbl)
                    .addComponent(minecraftDirField).addComponent(browseMcBtn))
                .addPreferredGap(ComponentPlacement.UNRELATED)
                .addGroup(memoryLimitAdjuster.verticalGroup(layout))
                .addPreferredGap(ComponentPlacement.UNRELATED).addComponent(advancedSettingsToggle)
                .addComponent(advancedPanel).addPreferredGap(ComponentPlacement.UNRELATED).addGroup(
                layout.createParallelGroup().addComponent(alwaysShowLauncherCB)
                    .addComponent(cancelBtn).addComponent(launchBtn)))));
   ...
   * @param version
   */
  protected static void launchError(final LauncherSettings settings, final VersionInfo version) {
    if (settings.debugConsole) {
      SwingUtilities.invokeLater(new Runnable() {
        @Override public void run() {
          LaunchErrorDialog dialog = new LaunchErrorDialog(
              ChunkyDeployer.commandString(ChunkyDeployer.buildCommandLine(version, settings)));
  ...
  private JPanel buildAdvancedPanel() {
    ...
    layout.setHorizontalGroup(layout.createSequentialGroup().addContainerGap().addGroup(
        layout.createParallelGroup().addGroup(layout.createSequentialGroup().addComponent(jreDirLbl)
            .addPreferredGap(ComponentPlacement.RELATED).addComponent(jreDirField)
            .addPreferredGap(ComponentPlacement.RELATED).addComponent(browseJreBtn)).addGroup(
            layout.createSequentialGroup().addComponent(javaOptionsLbl)
                .addPreferredGap(ComponentPlacement.RELATED).addComponent(javaOptions)).addGroup(
            layout.createSequentialGroup().addComponent(chunkyOptionsLbl)
                .addPreferredGap(ComponentPlacement.RELATED).addComponent(chunkyOptions))
            .addComponent(debugConsoleCB).addComponent(verboseLoggingCB)
            .addComponent(closeConsoleOnExitCB).addComponent(downloadSnapshotsCB).addGroup(
            layout.createSequentialGroup().addComponent(settingsDirLbl)
                .addPreferredGap(ComponentPlacement.RELATED).addComponent(settingsDir)))
        .addContainerGap());
    layout.setVerticalGroup(layout.createSequentialGroup().addContainerGap()
        .addPreferredGap(ComponentPlacement.UNRELATED).addGroup(
            layout.createParallelGroup(Alignment.BASELINE).addComponent(jreDirLbl)
                .addComponent(jreDirField).addComponent(browseJreBtn))
        .addPreferredGap(ComponentPlacement.UNRELATED).addGroup(
            layout.createParallelGroup(Alignment.BASELINE).addComponent(javaOptionsLbl)
                .addComponent(javaOptions)).addPreferredGap(ComponentPlacement.UNRELATED).addGroup(
            layout.createParallelGroup(Alignment.BASELINE).addComponent(chunkyOptionsLbl)
                .addComponent(chunkyOptions)).addPreferredGap(ComponentPlacement.UNRELATED)
        .addComponent(debugConsoleCB).addPreferredGap(ComponentPlacement.RELATED)
        .addComponent(verboseLoggingCB).addPreferredGap(ComponentPlacement.RELATED)
        .addComponent(closeConsoleOnExitCB).addPreferredGap(ComponentPlacement.UNRELATED)
        .addComponent(downloadSnapshotsCB).addPreferredGap(ComponentPlacement.UNRELATED).addGroup(
            layout.createParallelGroup(Alignment.BASELINE).addComponent(settingsDir)
                .addComponent(settingsDirLbl)).addContainerGap());
