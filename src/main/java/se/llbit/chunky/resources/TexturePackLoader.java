...
public class TexturePackLoader {
	...
	static {
		...
		allTextures.put("oak log top", new AlternateTextures(
				new SimpleTexture("assets/minecraft/textures/blocks/log_oak_top", Texture.woodTop),
				new SimpleTexture("textures/blocks/tree_top", Texture.woodTop),
				new IndexedTexture(0x15, Texture.woodTop)));
		// TODO add jungle, birch and spruce variants of log top
		...
		allTextures.put("jungle sapling", new AlternateTextures(
				new SimpleTexture("assets/minecraft/textures/blocks/sapling_jungle", Texture.jungleTreeSapling),
		...
		allTextures.put("log_jungle", new AlternateTextures(
				new SimpleTexture("assets/minecraft/textures/blocks/log_jungle", Texture.jungleTreeWood),
