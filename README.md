...
_Prerequisites:_ Chunky requires Java 8. It is recommended to install the 64-bit version if you have a 64-bit operating system (you most likely do). If you haven't installed it yet, [get Oracle Java 8 from here][13].
